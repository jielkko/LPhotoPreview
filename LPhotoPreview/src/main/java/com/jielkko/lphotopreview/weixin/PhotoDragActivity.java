package com.jielkko.lphotopreview.weixin;
...
import com.jielkko.lphotopreview.widget.DragPhotoView;

import java.util.ArrayList;
import java.util.List;


public class PhotoDragActivity extends AppCompatActivity {


    private List<LPhotoModel> imageList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_drag);
...
//        }
        ...
        mPage.setText(String.valueOf(page + 1) + "/" + imageList.size());

        mPhotoViews = new DragPhotoView[imageList.size()];
...
//            Glide.with(this).load("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1603091533219&di=0304262e58607b481a60b9a40a6baf94&imgtype=0&src=http%3A%2F%2Fa3.att.hudong.com%2F14%2F75%2F01300000164186121366756803686.jpg")
//                    .into(mImageView);

            //图片加载
            if( imageList.get(i).getUrl() != null){
                LPhotoPicker.getInstance().displayImage(this,  imageList.get(i).getUrl(), mPhotoViews[i]);

            }else{
                LPhotoPicker.getInstance().displayImage(this,  imageList.get(i).getPath(), mPhotoViews[i]);

            }

            mPhotoViews[i].setOnOnListener(new DragPhotoView.OnListener() {
                @Override
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                page = i;
                mPage.setText((page + 1) + "/" + imageList.size());
            }
